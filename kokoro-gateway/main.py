...
TTS_URL = _env("TTS_URL", "http://kokoro-vietnamese:7888/v1/tts")
BASE_PUBLIC_URL = _env("BASE_PUBLIC_URL", "http://kokoro-gateway:7899").rstrip("/")
...
app = FastAPI(title="Kokoro Gateway (Kokoro Vietnamese)", version="1.0.0")
...
class GatewayTTSRequest(BaseModel):
    ...
    voice: str = Field("diem_trinh", description="Giọng đọc (ví dụ: diem_trinh, hung_thinh...)")
